...
export default function PrivacyPolicy() {
  ...
  return (
    <article className="w-full max-w-3xl bg-white rounded-lg border border-gray-200 p-6 sm:p-10">
      <h1 className="text-2xl font-bold text-gray-900">Privacy Policy</h1>
      <p className="text-base my-5 leading-relaxed text-gray-700">
        ...
        <a href="https://goli.st">https://goli.st</a>, and other sites we
        own and operate.{" "}
      </p>
      ...
      <h3 className="text-xl font-semibold py-5 text-gray-900">
      ...
      <h4 className="text-xl font-semibold py-5 text-gray-900">Log Data</h4>
      <p className="text-base leading-relaxed text-gray-700">
      ...
      <h4 className="text-xl font-semibold py-5 text-gray-900">
      ...
      <ul className="text-base leadig-relaxed text-gray-700 list-inside list-disc">
        <li>Name</li>
        <li>Email</li>
