...
export function AdjustmentIcon({ className }) {
  return (
    <svg
      className={className}
      fill="none"
...
export function SolidHomeIcon({ className }) {
  return (
    <svg
      className={className}
      fill="currentColor"
...
export function RightChevronIcon({ className }) {
  return (
    <svg
      className={className}
      fill="currentColor"
...
export function PencilEditIcon({ className }) {
  return (
    <svg
      className={className}
      fill="none"
...
export function OkIcon({ className }) {
  return (
    <svg
      className={className}
      fill="none"
...
export function NewFileIcon({ className }) {
  return (
    <svg
      className={className}
      fill="none"
...
export function CircleX({ className }) {
  return (
    <svg
      className={className}
      fill="none"
